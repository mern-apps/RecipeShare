...
const GroupSmallDesign = ({ item }) => {
  ...
  if (!item) return null;
        ...
        console.log("ITEMS 111111119832984329832498732478932:", item);

  const imageSrc = item?.image || imageUrltemplate;
