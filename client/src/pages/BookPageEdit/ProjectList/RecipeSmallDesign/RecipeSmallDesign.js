...
import RecipeSub10 from './RecipeSub10';

import ItemDisplay2 from '../../../BookPageEdit/ItemDisplay/ItemDisplay2.js';
...
const RecipeSmallDesign = ({ task,pagemode }) => {
...
{task?.owner?.includes(user?._id) && (
  ...
  <>
    ...
    >
      <Typography variant="body1" sx={{ fontWeight: "bold" }}>
        {pdfLoading ? "מכין..." : "שמירת ספר כקובץ"}
      </Typography>
